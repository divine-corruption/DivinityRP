...
import { imagineImage } from "@/lib/ai/tools/imagine-image";
...
export async function POST(request: Request) {
  ...
  try {
    const { id, message, messages, selectedChatModel, selectedVisibilityType, customPrompt, characterData, loreData } =
      requestBody;
