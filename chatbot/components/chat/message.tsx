      ...
      return (
        <MessageContent
          className={cn("text-[13px] leading-[1.65]", {
            "w-fit max-w-[min(80%,56ch)] overflow-hidden break-words rounded-2xl rounded-br-lg border border-primary/30 bg-gradient-to-br from-primary/20 to-fuchsia-500/10 px-3.5 py-2 shadow-[0_2px_16px_-6px_var(--primary)]":
              message.role === "user",
          })}
